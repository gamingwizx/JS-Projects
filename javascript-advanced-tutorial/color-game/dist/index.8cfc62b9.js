...
})({"deqhj":[function(require,module,exports) {
...
const colorFormat = {
    "rgb": (0, _rgbJsDefault.default),
    "hex": (0, _hexJsDefault.default),
    "hsl": (0, _hslJsDefault.default)
};
(0, _helperJs.globalEventListener)("click", "input[name='format']", (e)=>{
    renderColorTiles();
});
(0, _helperJs.globalEventListener)("click", "input[name='difficulty']", (e)=>{
    renderColorTiles();
});
(0, _helperJs.globalEventListener)("click", "[data-color-tile]", (e)=>{
    const colorTiles = Array.from(colorGrid.children);
    const wrongTiles = colorTiles.filter((element)=>element.dataset.correct === "false");
    if (e.target.dataset.correct === "true") colorTitle.textContent = "Correct";
    else colorTitle.textContent = "Wrong";
    updateColorTiles(colorTiles);
});
(0, _helperJs.globalEventListener)("click", "[next-color]", (e)=>{
...
function generateColorDetails() {
    ...
    colorTile = (0, _helperJs.shuffle)(colorTile);
    return colorTile;
}
...
},{"lodash/fp":"pj41W","./helper.js":"8C2B8","./rgb.js":"6g21u","@parcel/transformer-js/src/esmodule-helpers.js":"b1wUL","./Hex.js":"fw3AM","./Hsl.js":"84hjW"}],"pj41W":[function(require,module,exports) {
var _ = require("78f5f2e192cd20c4").runInContext();
module.exports = require("7308bb42ba69c2cc")(_, _);

},{"78f5f2e192cd20c4":"cX2hE","7308bb42ba69c2cc":"hkO5P"}],"cX2hE":[function(require,module,exports) {
var global = arguments[3];
/**
 * @license
...
},{}],"hkO5P":[function(require,module,exports) {
var mapping = require("72915459611a16e2"), fallbackHolder = require("d891236dde43882c");
...
},{"72915459611a16e2":"cHfRU","d891236dde43882c":"cfCjP"}],"cHfRU":[function(require,module,exports) {
...
},{}],"8C2B8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function globalEventListener(event, element, callback, toggleCapture = false) {
...
function generateNumber(options) {
    ...
    const range = ranges[randomNumber({
        max: ranges.length - 1
    })];
...
function generateRange(options) {
    ...
    const ranges = [];
    if (maxAboveRange > minAboveRange) ranges.push({
        min: minAboveRange,
        max: maxAboveRange
    });
    if (maxBelowRange > minBelowRange) ranges.push({
        min: minBelowRange,
        max: maxBelowRange
    });
    return ranges;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"b1wUL"}],"b1wUL":[function(require,module,exports) {
...
},{}],"6g21u":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _helperJs = require("./helper.js");
...
class Rgb {
    ...
    static generateCorrectTile() {
        return new this((0, _helperJs.randomNumber)({
            max: MAX_RGB_VALUE
        }), (0, _helperJs.randomNumber)({
            max: MAX_RGB_VALUE
        }), (0, _helperJs.randomNumber)({
            max: MAX_RGB_VALUE
        }), true);
    ...
    generateRandomColor(NUMBER_RGB_TILES, difficulty) {
        return new this.constructor((0, _helperJs.generateNumber)({
            number: this.r,
            tolerance: (0, _configJs.DIFFICULTY_TOLERANCE)[difficulty],
            MAX_CUTOFF: MAX_RGB_VALUE
        }), (0, _helperJs.generateNumber)({
            number: this.g,
            tolerance: (0, _configJs.DIFFICULTY_TOLERANCE)[difficulty],
            MAX_CUTOFF: MAX_RGB_VALUE
        }), (0, _helperJs.generateNumber)({
...
},{"./helper.js":"8C2B8","@parcel/transformer-js/src/esmodule-helpers.js":"b1wUL","lodash/fp":"pj41W","./config.js":"bSr8D"}],"bSr8D":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DIFFICULTY_TOLERANCE", ()=>DIFFICULTY_TOLERANCE);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"b1wUL"}],"fw3AM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _helperJs = require("./helper.js");
var _configJs = require("./config.js");
...
var _rgbJsDefault = parcelHelpers.interopDefault(_rgbJs);
const MAX_RGB_VALUE = 255;
class Hex extends (0, _rgbJsDefault.default) {
    css() {
...
},{"./helper.js":"8C2B8","./config.js":"bSr8D","lodash/fp":"pj41W","@parcel/transformer-js/src/esmodule-helpers.js":"b1wUL","./rgb.js":"6g21u"}],"84hjW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _helperJs = require("./helper.js");
var _configJs = require("./config.js");
...
},{"./helper.js":"8C2B8","./config.js":"bSr8D","lodash/fp":"pj41W","@parcel/transformer-js/src/esmodule-helpers.js":"b1wUL"}]},["deqhj","6rimH"], "6rimH", "parcelRequired977")
