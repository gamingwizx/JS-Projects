...
function createBoard(BOARD_SIZE, minePosition) {
  return (0, _fp.times)(function (x) {
    return (0, _fp.times)(function (y) {
      return {
        x: x,
        y: y,
        minePosition: minePosition.some(function (object) {
...
function markTile(board, _ref, newTile) {
  var x = _ref.x,
    y = _ref.y;
...
function replaceTiles(board, _ref2, newTile) {
  var x = _ref2.x,
    y = _ref2.y;
  return board.map(function (row) {
    return row.map(function (tile) {
...
function revealTile(board, _ref3) {
  var x = _ref3.x,
    y = _ref3.y;
  var tile = board[x][y];
  ...
  var mines = adjacentTiles.filter(function (t) {
    return t.minePosition;
  });
  var newBoard = replaceTiles(board, {
    x: x,
    y: y
  }, _objectSpread(_objectSpread({}, tile), {}, {
...
function checkWin(board) {
  return board.every(function (row) {
    return row.every(function (tile) {
      return tile.status === TILE_STATUSES.NUMBER || tile.minePosition && (tile.status === TILE_STATUSES.HIDDEN || tile.status === TILE_STATUSES.MARKED);
    });
  });
}
...
function nearbyTiles(board, _ref4) {
  var x = _ref4.x,
    y = _ref4.y;
...
document.addEventListener("DOMContentLoaded", function () {
  var _testBoard$flat$filte, _testBoard, _testBoard$length, _testBoard2, _testBoard3;
  var testBoard;
  ...
  var title = document.querySelector(".subtext");
  var NUMBER_OF_MINES = (_testBoard$flat$filte = (_testBoard = testBoard) === null || _testBoard === void 0 ? void 0 : _testBoard.flat().filter(function (e) {
    return e.minePosition;
  }).length) !== null && _testBoard$flat$filte !== void 0 ? _testBoard$flat$filte : 2;
  var BOARD_SIZE = (_testBoard$length = (_testBoard2 = testBoard) === null || _testBoard2 === void 0 ? void 0 : _testBoard2.length) !== null && _testBoard$length !== void 0 ? _testBoard$length : 5;
  var boardElements = (_testBoard3 = testBoard) !== null && _testBoard3 !== void 0 ? _testBoard3 : (0, _minesweeper.createBoard)(BOARD_SIZE, generateMinePosition(BOARD_SIZE, NUMBER_OF_MINES));
  function render() {
    board.innerHTML = "";
  ...
  board.addEventListener("click", function (event) {
    ...
    boardElements = (0, _minesweeper.revealTile)(boardElements, event.target.dataset);
    checkWinLose();
    render();
  });
  board.addEventListener("contextmenu", function (event) {
    if (!event.target.matches("[data-status]")) return;
    var markedTile = boardElements[event.target.dataset.x][event.target.dataset.y];
    event.preventDefault();
    if (markedTile.status == TILE_STATUSES.MARKED) {
      boardElements = (0, _minesweeper.markTile)(boardElements, event.target.dataset, _objectSpread(_objectSpread({}, markedTile), {}, {
        status: TILE_STATUSES.HIDDEN
      }));
    } else {
      boardElements = (0, _minesweeper.markTile)(boardElements, event.target.dataset, _objectSpread(_objectSpread({}, markedTile), {}, {
  ...
  function getTileElements() {
    return boardElements.flatMap(function (row) {
  ...
  function checkWinLose() {
    ...
    if (lose) {
      ...
      boardElements = (0, _minesweeper.revealAllMines)(boardElements);
    }
  }
  function stopProp(e) {
