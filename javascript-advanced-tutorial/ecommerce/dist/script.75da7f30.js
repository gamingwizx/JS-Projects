...
function _getItems() {
  _getItems = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return apiInstance.get("/get-item");
        case 2:
          res = _context.sent;
...
//load the items on the ecommerce item list from the folder
//when you hit purchase, it will link to another page to the paypal page
//in the purchse page, you can make payment after filling up information
//then, after payment, the purchase will turn into download
//you can also store the information for storing the purchasese to each emails

console.log((0, _api.getItems)());
