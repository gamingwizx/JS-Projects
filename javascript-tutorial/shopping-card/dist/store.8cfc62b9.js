...
(0, _storeDefault.default)();
(0, _cartDefault.default)();

},{"./store":"9cnTH","./cart":"2pbNV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9cnTH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>renderItemsInStore);
...
function renderItemsInStore() {
    (0, _utility.globalEventListener)("click", "[data-add-to-cart-button]", (e)=>{
        const id = e.target.closest("[data-item-id]").dataset.itemId;
        const item = (0, _itemsJsonDefault.default).find((item)=>item.id === parseInt(id));
        (0, _cartJs.addToCart)(item);
    });
    const dataContainer = document.querySelector("[data-store-container]");
    (0, _itemsJsonDefault.default).forEach((item)=>{
...
},{}],"2pbNV":[function(require,module,exports) {
/* 
...
*/ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>setupCart);
...
function setupCart() {
    (0, _utilityJs.globalEventListener)("click", "[data-remove-from-cart-button]", (e)=>{
...
},{"./items.json":"2d50i","./utility.js":"2J5qt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["86oZd","6rimH"], "6rimH", "parcelRequire3518")
